...
describe("Login page tests", function () {
  ...
  //test11: to check that error is displayed when user tries to reach /inventory endpoint while not logged in
  it("navigate to Inventory while not logged in", async function () {
    // ----Execution Steps----
    // launch browser
